...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
  if not item:isContainer() then
    player:sendTextMessage(MESSAGE_STATUS_SMALL, "Este cubo nao e container! Use um Horadric Cube 40080.")
    return false
  end
  ...
  local outIdMap = {
    ["Flawed Amethyst"] = 40051,
    ["Amethyst"] = 40052,
    ["Flawless Amethyst"] = 40053,
    ["Perfect Amethyst"] = 40054,
    ["Flawed Topaz"] = 40055, -- placeholder
    ["Perfect Topaz"] = 40056,
    ["Perfect Ruby"] = 40057,
    ["Perfect Sapphire"] = 40058,
    ["Amn"] = 40010,
    ["Sol"] = 40011,
    ["Shael"] = 40012,
    ["Dol"] = 40013,
    ...
    ["Cham"] = 40031,
    ["Zod"] = 40032,
    ["socketed_armor"] = 40041,
    ["socketed_helm"] = 40040,
    ["socketed_weapon"] = 40006,
    ["socketed_shield"] = 40040,
    ["Exceptional Weapon"] = 2383, -- giant sword etc exemplo
    ["Elite Weapon"] = 2390,
    ["Exceptional Armor"] = 2463,
    ["Elite Armor"] = 2466,
    ["Portal to Cow Level"] = 40081,
    ["Portal to Uber Bosses"] = 40070,
    ["Token of Absolution"] = 40082,
    ["Repaired Weapon"] = 2383,
    ["Repaired Armor"] = 2463,
  }

  local outId = outIdMap[out] or 40054 -- default perfect amethyst
